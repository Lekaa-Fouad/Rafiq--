...
import { API_URL as BACKEND_URL, API_KEY } from "../../src/api/client";
import localFloorPlans from "../../src/data/floorPlans.json";
...
export default function NavigateScreen() {
  ...
  // ── Voice recorder hook ────────────────────────────────────────────────────
  const { recordingState: recorderState, isRecording, startRecording, stopRecording } = useVoiceRecorder();
